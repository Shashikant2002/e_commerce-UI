          ...
          <div className="detailPage commonSec">
            <div className="container flex">
              ...
              <div className="content">
                ...
                <h5><span>Status: </span> <span className='coloGreen'>In Stock {product.stock}</span></h5>
                <h4>Description: </h4>
            ...
            <div className="container">
              ...
              <div className="reviews flex justifyCenter flexWrap comCardGap">
                {
                  product.reviews && product.reviews.length < 1 ? <h5>This product Reviews not Found</h5> :
                    product.reviews && product.reviews.map((ele, i) => {
                      return (
                        <Reviews key={i} revData={ele} />
                      )
                    })
