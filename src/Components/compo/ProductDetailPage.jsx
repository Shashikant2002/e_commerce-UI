...
const ProductDetailPage = () => {
  ...
  const showsubmitReview = () => {
    document
      ...
      .classList.toggle("showsubmitReview");
  };
        ...
        <div className="detailPage commonSec">
          <div className="container flex">
            ...
            <div className="content">
              ...
              <h5>
                <span>Status: </span>{" "}
                <span className="coloGreen">
                  {product.stock < 1 ? "Out of Stock" : <span>In Stock</span>}{" "}
                  {product.stock}
                </span>
              </h5>
              <h4>Description: </h4>
            ...
            <div
              id="submitReview"
              className="submitReview flex alignCenter justifyCenter"
            >
              <div className="reviewform">
                <span onClick={() => showsubmitReview()} className="close">
                  <FaWindowClose />
                </span>
                <form action="/">
                  <textarea
            ...
            <div className="reviews flex justifyCenter flexWrap comCardGap">
              {product.reviews && product.reviews.length < 1 ? (
                ...
                product.reviews.map((ele, i) => {
                  return <Reviews key={i} index={i} revData={ele} />;
                })
              )}
            </div>
          </div>
